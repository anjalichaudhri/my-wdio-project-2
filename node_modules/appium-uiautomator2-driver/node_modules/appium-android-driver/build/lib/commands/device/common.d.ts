 ...
 */
export function createADB(this: import("../../driver").AndroidDriver, opts?: null): Promise<import('appium-adb').ADB>;
/**
 * @this {AndroidDriver}
 ...
 * @returns
 */
export function initDevice(this: import("../../driver").AndroidDriver): Promise<any>;
